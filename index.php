    ...
    <table class="table table-stripped table-bordered table-hover mt-5">
      ...
      ?>
        <tr>
          ...
          <td><div class="text-center"><a href="delete.php?delete_id=<?php echo $Result['ID']; ?>" class="glyphicon glyphicon-pencil" title="Edit"></a> <a href="update.php?edit_id=<?php echo $Result["ID"]; ?>" class="btn btn-warning" >แก้ไข</a></div></td>
        </tr>
      <?php
      }
      ?>
